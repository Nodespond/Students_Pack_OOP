    ...
    public:
        ...
        void ToldAboutEachOther() {
            ...
            for (int i = 0; i < GetChildrenSize(); i++) {
                    cout << this->GetStudent(i).GetName() << " study very well!\n";
            }
        }
        ...
        void ToldAboutSomebody() {
            ...
            childIndex = rand() % (GetChildrenSize() + 1);
            cout << this->GetStudent(childIndex).GetName() << " - my best child! I love you!\n";
        }
        ...
        void ToldAboutYou(Student student) {
            if (find(GetStudentS().begin(), GetStudentS().end(), student) == GetStudentS().end()) {
                if (GetMood() == true)
                    cout << "So cute child!!\n";
                else cout << "OOh , I don't like you!\n";
                return;
            }
            cout << "THIS IS MY GOOD BOOOOOOY!\n";
        }
